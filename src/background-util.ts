export const injectBackgroundInternalMessageListener = () => {
    console.log("injectBackgroundInternalMessageListener");
...
export const injectBackgroundExternalMessageListener = () => {
    console.log("injectBackgroundExternalMessageListener");
    ...
    chrome.runtime.onMessageExternal.addListener(
        async (request, sender, sendResponse) => {
            ...
            const prefix = "https://sp.ke.m-pesa.com/";
            const existingTab = tabs.find(t => t.url!.startsWith(prefix))!;
          //  await chrome.tabs.update(existingTab.id, { active: true });
